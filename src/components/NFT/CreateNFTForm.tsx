...
export default function CreateNFTForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const signature = await createNFT(wallet,name, description, symbol, imageUrl, supply);
   ...
   <div>
     ...
     <div className="bg-white rounded-xl shadow-md p-4 lg:p-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg lg:text-xl font-semibold text-gray-800">Create NFT</h2>
      </div>
